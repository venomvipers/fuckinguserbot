...
async def _(event):
    ...
    packname = f"@venom_vipers Peru Sir Ka KangPack {userid}"
    packshortname = f"venom_vipers_sir_ka_pack_{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        if userid == 719877937:
            packshortname = "TheVenom_Animated"
        else:
