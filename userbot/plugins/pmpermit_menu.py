...
async def _(event):
    ...
    if not pmpermit_sql.is_approved(chat_id):
        ...
        if event.is_private:
         ...
         ONE = ("__Okay. Your request has been registered, nhi toh pele jaaoge🙂. Do not spam my master's inbox.You can expect a reply within 24 light years. He is a busy man, unlike you probably.__\n\n"
